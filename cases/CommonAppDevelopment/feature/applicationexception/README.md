...
本示例介绍了通过应用事件打点[hiAppEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/_hi_app_event-V5)获取上一次应用异常信息的方法，主要分为应用崩溃、应用卡死以及系统查杀三种。
...
[应用事件打点HiAppEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/_hi_app_event-V5)

[数据懒加载LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/ts-rendering-control-lazyforeach-V5)
