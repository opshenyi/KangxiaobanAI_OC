...
5. 将RGB颜色格式转换为HSV格式，转换公式如图所示。![RGB转为HSV](src/main/resources/base/media/icon_main_color_rgb_to_hsv.png)
...
7. 将HSV格式转换为RGB格式，转换公式如图所示。![HSV转为RGB](src/main/resources/base/media/icon_main_color_hsv_to_rgb.png)
...
[**Image组件**](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-image-0000001815927572)