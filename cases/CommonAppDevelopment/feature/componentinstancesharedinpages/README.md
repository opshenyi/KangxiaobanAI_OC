...
### 模块依赖
本示例中的地址选择弹窗通过引入[mapthumbtack](../mapthumbtack/README.md)模块的[LocationAndPopUpComponent](../mapthumbtack/Index.ets)组件实现，还依赖common模块来实现[日志](../../common/utils/src/main/ets/log/Logger.ets)的打印、[资源](../../common/utils/src/main/resources/base/element)的调用，依赖routermodule模块来实现[路由注册管理](../routermodule/Index.ets)。
