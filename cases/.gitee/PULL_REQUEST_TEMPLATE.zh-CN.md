...
**测试用例结果截图（测试用例必须包含：本案例各个功能）**：(Pass/Fail/评估不涉及)
...
**提交CheckList**：
  ...
  1、新增模块需添加ReadMe.md，ReadMe需包含**是否支持模拟器**、场景介绍、知识点介绍、预览动图、参考资料等，参考根目录模板：是/否/不涉及
...
**编码规范CheckList**：
  ...
  6、资源命名使用小写加下划线的规则，且需要加上模块前缀，例如barchat_show_text.png（模块_资源.png）；
