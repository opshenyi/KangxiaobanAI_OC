...
在滑动场景下，常常会对同一类自定义组件的实例进行频繁的创建与销毁。此时可以考虑通过组件复用减少频繁创建与销毁的能耗。组件复用时，可能存在许多影响组件复用效率的操作，本篇文章将重点介绍如何通过**组件复用四板斧**提升复用性能。
...
![noBuilder](./pic/component_recycle_case/noBuilder.png)
...
![useBuilder](./pic/component_recycle_case/useBuilder.png)
...
![noModifier1](./pic/component_recycle_case/noModifier1.png)
...
![noModifier2](./pic/component_recycle_case/noModifier2.png)

![noModifier3](./pic/component_recycle_case/noModifier3.png)
...
![useUpdater1](./pic/component_recycle_case/useUpdater1.png)
...
![useProp](./pic/component_recycle_case/useProp.png)
...
![useLink](./pic/component_recycle_case/useLink.png)
...
![refresh_auto_fresh_variable](./images/avoid_auto_variable_false_trace.png)
...
![avoid_refresh_auto_fresh_variable](./images/avoid_auto_vaiable_true_trace.png)
...
![noReuseId](./pic/component_recycle_case/noReuseId.png)
...
![ReuseId](./pic/component_recycle_case/ReuseId.png)
...
![FuncParam](./pic/component_recycle_case/FuncParam.png)
...
![noFuncParam](./pic/component_recycle_case/noFuncParam.png)
