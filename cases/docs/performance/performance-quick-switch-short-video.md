...
7. 设置AVPlayer监听关闭并释放资源。
   ...
   ```
## 完整示例
[在线短视频流畅切换](../../test/performance/quick_switch_short_video)

## 参考文档

[使用AVPlayer开发音频播放功能(ArkTS)](../media/media/using-avplayer-for-playback.md)

[音频和视频-视频播放器(ArkTS)](https://developer.huawei.com/consumer/cn/codelabsPortal/carddetails/tutorials_NEXT-VideoPlayer)

[LazyForEach:数据懒加载](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/ts-rendering-control-lazyforeach-V5)

[容器组件：Swiper](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/ts-container-swiper-V5)

[基础组件：Slider](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/ts-basic-components-slider-V5)