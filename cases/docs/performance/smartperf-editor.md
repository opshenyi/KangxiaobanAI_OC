# 性能测试工具SmartPerf Editor使用指导（已废弃）
## 概述
...
- Windows 7及以上操作系统的电脑。
- 工具需要使用华为账号登录，需要提前注册。
- 工具下载地址：[HiSmartPerf-Editor](https://developer.huawei.com/consumer/cn/doc/AppGallery-connect-Guides/smartperf-tool-download-0000001530830070)。
