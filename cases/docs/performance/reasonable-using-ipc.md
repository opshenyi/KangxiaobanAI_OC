...
1. [@ohos.rpc (RPC通信)](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis-ipc-kit/js-apis-rpc.md)

2. [IPC与RPC通信概述](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/ipc/ipc-rpc-overview.md)

3. [性能分析工具CPU Profiler](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/performance/application-performance-analysis.md)

4. [@ohos.wifiManager (WLAN)(推荐)](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis-connectivity-kit/js-apis-wifiManager.md)