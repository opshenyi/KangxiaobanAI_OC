...
- 国际化使用[Localization Kit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/js-apis-intl-V5)接口替换ArkTS运行时接口
...
下面以[getStringSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references-V5/js-apis-resource-manager-V5#getstringsync10)为例，测试一下这两种参数在方法中的使用是否会有耗时区别。

### 通过resource对象获取([源码示例链接](/test/performance/reasonable_using_system_interfaces/entry/src/main/ets/pages/GetStringSync.ets))
...
### 通过id获取([源码示例链接](/test/performance/reasonable_using_system_interfaces/entry/src/main/ets/pages/GetStringSyncAfter.ets))
...
### 反例([源码示例链接](/test/performance/reasonable_using_system_interfaces/entry/src/main/ets/pages/UsingZeroWidthSpace.ets))
...
### 正例([源码示例链接](/test/performance/reasonable_using_system_interfaces/entry/src/main/ets/pages/UsingWordBreak.ets))
...
### 使用同步接口getAnonymousIdSync([源码示例链接](/test/performance/reasonable_using_system_interfaces/entry/src/main/ets/pages/GetAnonymousIdSync.ets))
...
使用IDE的[Profiler](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-insight-description-V5)工具抓取Trace数据，查看同步接口getAnonymousIdSync的调用耗时为150.695ms。

![](images/reasonable_using_system_interfaces_getanonymousadsync.png)

### 使用异步接口getAnonymousId([源码示例链接](/test/performance/reasonable_using_system_interfaces/entry/src/main/ets/pages/GetAnonymousId.ets))
...
使用IDE的[Profiler](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-insight-description-V5)工具抓取Trace数据，查看异步接口getAnonymousId的调用耗时为11.988ms。
...
### 使用ArkTS运行时接口Intl([源码示例链接](/test/performance/reasonable_using_system_interfaces/entry/src/main/ets/pages/RuntimeInterface.ets))
...
### 使用Localization Kit接口intl([源码示例链接](/test/performance/reasonable_using_system_interfaces/entry/src/main/ets/pages/LocalizationKitInterface.ets))
...
使用IDE的[Profiler](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-insight-description-V5)工具，分别获取使用ArkTS运行时接口和使用Localization Kit接口创建100次同类对象的耗时数据，从首次创建耗时、首次创建之后单次平均耗时和100次创建总耗时三个维度进行对比分析：
