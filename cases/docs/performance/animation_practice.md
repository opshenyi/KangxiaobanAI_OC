...
![](figures/animation_practice_1_1.gif)
...
![](figures/animation_practice_1_2.gif)

### 组件布局改动时使用图形变换属性动画
改动组件的布局显示有两种方式：

- 改动[布局属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/arkts-attribute-animation-overview-V5)。当布局属性发生改变时，界面将重新布局。常见的布局属性有width、height、layoutWeight等。
- 改动[图形变换属性](https://developer.huawei.com/consumer/cn/doc/best-practices-V5/bpta-fair-use-animation-V5#section1723931117204)。图形变换是对组件布局结果的变换操作，如平移、旋转、缩放等操作。
...
![](figures/animation_practice_1.png)

**优化后耗时：**

![](figures/animation_practice_2.png)

|  | **动画耗时**  | **说明** |
| ------ | ------- | ------------------------------------- |
| 优化前  | 2ms600μs | 改动布局属性将重新布局，耗时久 |
| 优化后  | 1ms240μs | 改动图形变换属性不会重新布局，耗时短 |
...
![](figures/animation_practice_3.png)

**优化后耗时：**

![](figures/animation_practice_4.png)

|  | **动画耗时**  | **说明** |
| ------ | ------- | ------------------------------------- |
| 优化前  | 1ms379μs | 在不同的动画闭包中，耗时久 |
| 优化后  | 999μs | 合并在一个动画闭包，耗时短 |
...
![](figures/animation_practice_4_1.gif)
...
![](figures/animation_practice_4_2.gif)
...
![](figures/animation_practice_4_3.gif)
