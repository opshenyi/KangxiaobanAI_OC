...
更详细的API文档请参考：[属性动画](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/apis-arkui/arkui-ts/ts-animatorproperty.md)。
...
更详细的API文档请参考：[显式动画](https://docs.openharmony.cn/pages/v4.1/zh-cn/application-dev/reference/apis-arkui/arkui-ts/ts-explicit-animation.md)。
...
更详细的API文档请参考：[Tabs-animationduration](https://gitee.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis-arkui/arkui-ts/ts-container-tabs.md#animationduration)。
