...
**同层渲染**的简介可以参考：
1. [同层渲染——华为开发者联盟](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/bpta-web-develop-optimization-0000001890643105-V5#section8520716143919)
2. [ArkWeb同层渲染](../../CommonAppDevelopment/feature/nativeembed)案例。
